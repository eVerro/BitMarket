...
urlpatterns = patterns('',
    ...
    (r'^user/deposit/(?P<wallet>\w+)/$', 'BitMarket.index.views.deposit'),
    (r'^user/deposit/(?P<wallet>\w+)/confirm/$', 'BitMarket.index.views.depositConfirm'),
    (r'^user/withdraw/(?P<wallet>\w+)/$', 'BitMarket.index.views.withdraw'),
    (r'^user/withdraw/(?P<wallet>\w+)/confirm/$', 'BitMarket.index.views.withdrawConfirm'),
    (r'^user/withdraw/(?P<wallet>\w+)/confirmSMS/$', 'BitMarket.index.views.withdrawConfirmSMS'),
